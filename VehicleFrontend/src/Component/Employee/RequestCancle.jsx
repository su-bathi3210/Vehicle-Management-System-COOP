...
const RequestCancel = () => {
    ...
    const fetchMyRequests = async () => {
        try {
            const res = await axios.get(
                `${API_BASE_URL}/vehicle-requests/my-requests?travelerName=${travelerName}&phoneNumber=${phoneNumber}`
            );
    ...
    const handleCancel = async (reqId) => {
        ...
        try {
            const res = await axios.put(`${API_BASE_URL}/vehicle-requests/${reqId}/cancel`, {
                travelerName,
                phoneNumber,
                reason,
            });
